...
namespace MonoGameProject
{
    ...
    public class Boss : Thing
    {
        ...
        public Boss(Game1 Game1)
        {
            ...
            var arm = CreateFlippableAnimation(green, RIGHT_ARM_Z, GeneratedContent.Create_knight_Torso_Humanoid_Shell_Arm);
            var arm_attack = CreateFlippableAnimation(green, RIGHT_ARM_Z, GeneratedContent.Create_knight_Torso_Humanoid_Shell_Arm_attack);
            AddAnimation(
                new Animator(
            ...
            AddAnimation(CreateFlippableAnimation(green, LEFT_ARM_Z, GeneratedContent.Create_knight_Torso_Humanoid_Shell_Arm, true));
            AddAnimation(CreateFlippableAnimation(green, RIGHT_FEET_Z, GeneratedContent.Create_knight_Torso_Humanoid_turtle_feet));
            AddAnimation(CreateFlippableAnimation(green, LEFT_FEET_Z, GeneratedContent.Create_knight_Torso_Humanoid_turtle_feet, true));
