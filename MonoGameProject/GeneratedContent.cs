...
{  
    ...
    public static Animation Create_knight_Legs_Crouching(int X, int Y, float Z, int? Width = null, int? Height = null, bool Flipped = false)
    {
        var animation = new Animation(
            ...
            new AnimationFrame("knight", X, Y, Width ?? 99, Height ?? 60, new Rectangle(337, 105, 99, 60)){ RenderingLayer = Z, Flipped = Flipped }
        );
    ...
    public static Animation Create_knight_Legs_slide_wall(int X, int Y, float Z, int? Width = null, int? Height = null, bool Flipped = false)
    {
        var animation = new Animation(
            
            new AnimationFrame("knight", X, Y, Width ?? 77, Height ?? 128, new Rectangle(154, 105, 77, 128)){ RenderingLayer = Z, Flipped = Flipped }
        );
    ...
    public static Animation Create_knight_block(int X, int Y, float Z, int? Width = null, int? Height = null, bool Flipped = false)
    {
        var animation = new Animation(
            ...
            new AnimationFrame("knight", X, Y, Width ?? 106, Height ?? 106, new Rectangle(231, 105, 106, 106)){ RenderingLayer = Z, Flipped = Flipped }
        );
    ...
    public static Animation Create_knight_dead_tree(int X, int Y, float Z, int? Width = null, int? Height = null, bool Flipped = false)
    {
        var animation = new Animation(
            ...
            new AnimationFrame("knight", X, Y, Width ?? 153, Height ?? 196, new Rectangle(436, 105, 153, 196)){ RenderingLayer = Z, Flipped = Flipped }
        );
    ...
    public static Animation Create_knight_head(int X, int Y, float Z, int? Width = null, int? Height = null, bool Flipped = false)
    {
        var animation = new Animation(
            ...
            new AnimationFrame("knight", X, Y, Width ?? 112, Height ?? 106, new Rectangle(589, 105, 112, 106)){ RenderingLayer = Z, Flipped = Flipped }
        );
    ...
    public static Animation Create_knight_hit_effect(int X, int Y, float Z, int? Width = null, int? Height = null, bool Flipped = false)
    {
        var animation = new Animation(
            ...
            new AnimationFrame("knight", X, Y, Width ?? 175, Height ?? 170, new Rectangle(701, 105, 175, 170)){ RenderingLayer = Z, Flipped = Flipped },
            ...
            new AnimationFrame("knight", X, Y, Width ?? 175, Height ?? 170, new Rectangle(350, 471, 175, 170)){ RenderingLayer = Z, Flipped = Flipped },
            new AnimationFrame("knight", X, Y, Width ?? 175, Height ?? 170, new Rectangle(701, 105, 175, 170)){ RenderingLayer = Z, Flipped = Flipped }
        );
    ...
    public static Animation Create_knight_roof_bang_head(int X, int Y, float Z, int? Width = null, int? Height = null, bool Flipped = false)
    {
        var animation = new Animation(
            ...
            new AnimationFrame("knight", X, Y, Width ?? 132, Height ?? 93, new Rectangle(525, 471, 132, 93)){ RenderingLayer = Z, Flipped = Flipped }
        );
    ...
    public static Animation Create_knight_roof_bang_legs(int X, int Y, float Z, int? Width = null, int? Height = null, bool Flipped = false)
    {
        var animation = new Animation(
            ...
            new AnimationFrame("knight", X, Y, Width ?? 154, Height ?? 53, new Rectangle(657, 471, 154, 53)){ RenderingLayer = Z, Flipped = Flipped }
        );
    ...
    public static Animation Create_knight_sky(int X, int Y, float Z, int? Width = null, int? Height = null, bool Flipped = false)
    {
        var animation = new Animation(
            ...
            new AnimationFrame("knight", X, Y, Width ?? 113, Height ?? 113, new Rectangle(811, 471, 113, 113)){ RenderingLayer = Z, Flipped = Flipped }
        );
