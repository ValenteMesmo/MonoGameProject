...
{  
    ...
    public static Animation Create_knight_Legs_Walking(int X, int Y, float Z, int Width, int Height, bool Flipped = false)
    {
        var animation = new Animation(
            ...
            new AnimationFrame("knight", X, Y, Width, Height, new Rectangle(0+5, 1188+5, 593-10, 596-10)){ RenderingLayer = Z, Flipped = Flipped },
    ...
    public static Animation Create_knight_block(int X, int Y, float Z, int Width, int Height, bool Flipped = false)
    {
        var animation = new Animation(
            ...
            new AnimationFrame("knight", X, Y, Width, Height, new Rectangle(1186+5, 2380+5, 112-10, 112-10)){ RenderingLayer = Z, Flipped = Flipped }
        );
    ...
    public static Animation Create_knight_dead_tree(int X, int Y, float Z, int Width, int Height, bool Flipped = false)
    {
        var animation = new Animation(
            ...
            new AnimationFrame("knight", X, Y, Width, Height, new Rectangle(1298+5, 2380+5, 593-10, 593-10)){ RenderingLayer = Z, Flipped = Flipped }
        );
